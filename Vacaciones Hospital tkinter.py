...
class Trabajador:
    def __init__(self, parent):
        self.frame = tk.LabelFrame(parent, text="Datos del Trabajador", padx=10, pady=10, bg="pink")
        ...
        for i, (label, widget) in enumerate(campos):
            tk.Label(self.frame, text=label, bg="pink").grid(row=i, column=0, sticky="w")
...
class Jornada:
    def __init__(self, parent):
        self.frame = tk.LabelFrame(parent, text="Datos de la Jornada", padx=10, pady=10, bg="pink")
        self.frame.pack(padx=10, pady=5, fill="x")
...
class AplicacionVacaciones:
    ...
    def crear_widgets(self):
        periodo_frame = tk.Frame(self.root, bg="pink")
        periodo_frame.pack(pady=10)

        tk.Label(periodo_frame, text="Periodo vacacional:", bg="pink").grid(row=0, column=0, sticky="w")
